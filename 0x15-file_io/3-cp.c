 ...
 * Return: 0 on success.
 *
 * Description: If the argument count is incorrect - this is an exit code 97.
 *              If file_from does not exist or cannot be read - this is an exit code 98.
 *              If file_to cannot be created or written to - this is an exit code 99.
 *              If file_to or file_from cannot be closed - this is an exit code 100.
 */
