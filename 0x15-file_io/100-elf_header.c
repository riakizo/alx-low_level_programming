...
/**
 * print_type - The print_type prints the type of an ELF header.
 ...
 * @elf: IS a file descriptor of the ELF file.
 *
 * Description: If the file cannot be closed - this is exit code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
